...
ActiveRecord::Schema.define(version: 20150211083021) do
  ...
  create_table "detail_emails", force: true do |t|
    t.string   "from"
    t.string   "to"
    t.text     "body"
    t.string   "title"
  ...
  add_index "detail_emails", ["user_id"], name: "index_detail_emails_on_user_id"
